...
export default function MyPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 pb-24">
      ...
      {/* Profile Section */}
      <section className="mb-12">
        <Card className="border border-purple-100/50 shadow-lg bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50">
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600 text-lg mb-1">{userProfile.email}</p>
              ...
              <div className="flex flex-col gap-4 min-w-[200px]">
                <div className="flex items-center gap-3 bg-white/60 rounded-xl p-3 backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-500">연속 학습</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white/60 rounded-xl p-3 backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-500">총 학습 시간</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white/60 rounded-xl p-3 backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-500">완료한 학습</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="border border-purple-100/50 shadow-lg bg-white">
            ...
            <CardContent className="flex flex-col items-center">
              ...
              <div className="w-full max-w-[120px] h-32 bg-gray-100 rounded-full overflow-hidden relative mb-4">
                <div
      ...
      <section>
        <h3 className="text-2xl font-bold text-gray-900 mb-6">계정 설정</h3>
        <Card className="border border-purple-100/50 shadow-lg bg-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-gray-900">비밀번호</span>
                </div>
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-gray-900">이메일 알림</span>
                </div>
                <span className="text-gray-500 font-medium">
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-gray-900">푸시 알림</span>
                </div>
                <span className="text-gray-500 font-medium">
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-gray-900">언어</span>
                </div>
                <span className="text-gray-500 font-medium">
